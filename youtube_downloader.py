...
# Download Video
def download_video(quality:int):
    global TKINTER_WIDGETS
    ...
    try:
        ...
        # Disable buttons
        TKINTER_WIDGETS['button_download_high'].configure(state=DISABLED)
        TKINTER_WIDGETS['button_download_low'].configure(state=DISABLED)
...
def notify_download_completed(stream, file_handle):
    ...
    TKINTER_WIDGETS['button_download_low'].configure(state=NORMAL)
    TKINTER_WIDGETS['button_download_high'].configure(state=NORMAL)
...
def homepage():
    ...
    try:
        ...
        # Entry Download Path
        TKINTER_WIDGETS['entry_download_path'] = customtkinter.CTkEntry(master=frame_yt, placeholder_text=DOWNLOADS_FOLDER, width=300, height=30, border_width=2, corner_radius=10, font=('Roboto-Medium', 10))
        ...
        # Button Download low-quality
        TKINTER_WIDGETS['button_download_low'] = customtkinter.CTkButton(master=ROOT, text="Download L.quality", width=70, fg_color="#0D8A66", hover_color="#11B384", text_color="#FFF", command=low_quality)
        TKINTER_WIDGETS['button_download_low'].grid(row=2, column=0, padx=50, sticky='e')

        #button download high-quality
        TKINTER_WIDGETS['button_download_high'] = customtkinter.CTkButton(master=ROOT, text="Download H.quality", width=70, fg_color="#0D8A66", hover_color="#11B384", text_color="#FFF", command=high_quality)
        TKINTER_WIDGETS['button_download_high'].grid(row=2, column=1, padx=20, sticky='e')
        ...
        TKINTER_WIDGETS['button_exit'].grid(row=2, column=2, padx=20, sticky='e')
